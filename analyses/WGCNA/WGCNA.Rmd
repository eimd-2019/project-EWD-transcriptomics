...
zosteraGeneAnnot <- zosteraGeneAnnot[,-c(3,10)] #Remove 10th column
...
for (module in namesModules) {
  ...
  annotLLIDs <- subset(zosteraGeneAnnot, subset = zosteraGeneAnnot$geneIDs == modLLIDs) #Subset annotated list based on gene IDs in each module
