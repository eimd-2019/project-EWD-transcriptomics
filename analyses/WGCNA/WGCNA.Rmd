...
Since there's only one significant term, there's no need to plot.

```{r}
read.delim("MWU_BP_brown-Table-of-Significance-Measures.csv", sep = " ", header = TRUE) %>%
  filter(p.adj < 0.1)
#GO:0003333;GO:0006865;GO:1905039;GO:0015849;GO:1903825;GO:0098656;GO:0034220;GO:0055085 transmembrane transport	0
```
...
# GO:0000943	retrotransposon nucleocapsid	0.00
# GO:0099080	supramolecular complex	0.05
```
...
# GO:0003700;GO:0140110	transcription regulator activity	0.050
```
...
```{r}
read.delim("MWU_BP_blue-Table-of-Significance-Measures.csv", sep = " ", header = TRUE) %>%
  filter(p.adj < 0.1)
#GO:0002376	immune system process	0.05
```
...
# GO:0003735;GO:0005198	structural molecule activity	0.05
```
...
sigGOMWUResults <- rbind(read.delim("MWU_BP_brown-Table-of-Significance-Measures.csv", sep = " ", header = TRUE) %>%
                         ...
                         read.delim("MWU_MF_magenta-Table-of-Significance-Measures.csv", sep = " ", header = TRUE) %>%
                           filter(p.adj < 0.1)) %>%
  mutate(module = c("brown", "brown", "brown", "blue", "magenta"),
         cat = c("Biological Process", "Biological Process", "Molecular Function", "Biological Process", "Molecular Function")) %>%
