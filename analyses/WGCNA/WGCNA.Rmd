...
```{r}
write.table(brownGeneListAnnot, "zosteraGeneList-brown-annot.txt", sep = "\t", quote = FALSE) #Save individual module list
```
...
```{r}
write.table(yellowGeneListAnnot, "zosteraGeneList-yellow-annot.txt", sep = "\t", quote = FALSE) #Save individual module list
```
...
```{r}
write.table(blueGeneListAnnot, "zosteraGeneList-blue-annot.txt", sep = "\t", quote = FALSE) #Save individual module list
```
...
```{r}
write.table(magentaGeneListAnnot, "zosteraGeneList-magenta-annot.txt", sep = "\t", quote = FALSE) #Save individual module list
```
